...
const StatusLabel = ({ status }: { status: StatusesType }) => {
  ...
  switch (status) {
    case 'completed':
      return (
        <div className="flex items-center space-x-2 p-2 dark:bg-background dark:border bg-green-100 rounded-md">
    ...
    case 'in-progress':
      return (
        <div className="flex items-center space-x-2 p-2 dark:bg-background dark:border bg-blue-100 rounded-md">
    ...
    case 'not-started':
      return (
        <div className="flex items-center space-x-2 p-2 dark:bg-background dark:border bg-orange-100 rounded-md">
    ...
    case 'scrapped':
      return (
        <div className="flex items-center space-x-2 p-2 dark:bg-background dark:border bg-red-100 rounded-md">
